...
const (
	...
	Envelope_TYPING        Envelope_Type = 4
	Envelope_SYNC_MESSAGE  Envelope_Type = 5
)
...
func (Envelope_Type) EnumDescriptor() ([]byte, []int) {
	return file_proto_envelope_proto_rawDescGZIP(), []int{0, 0}
}
...
type Envelope struct {
	...
	Signature     []byte                 `protobuf:"bytes,6,opt,name=signature,proto3" json:"signature,omitempty"` // HMAC para validar integridade
	ClientId      string                 `protobuf:"bytes,7,opt,name=clientId,proto3" json:"clientId,omitempty"`   // ID da mensagem no cliente para deduplicação
	Ttl           uint32                 `protobuf:"varint,8,opt,name=ttl,proto3" json:"ttl,omitempty"`            // Time-to-live em segundos (default 86400 = 24h)
	GroupIds      []string               `protobuf:"bytes,9,rep,name=groupIds,proto3" json:"groupIds,omitempty"`   // Para mensagens de grupo
...
func (x *Envelope) GetGroupIds() []string {
	if x != nil {
		return x.GroupIds
	}
	return nil
...
const file_proto_envelope_proto_rawDesc = "" +
	"\n" +
	"\x14proto/envelope.proto\x12\asigmapb\"\xfb\x02\n" +
	"\bEnvelope\x12*\n" +
	...
	"\tsignature\x18\x06 \x01(\fR\tsignature\x12\x1a\n" +
	"\bclientId\x18\a \x01(\tR\bclientId\x12\x10\n" +
	"\x03ttl\x18\b \x01(\rR\x03ttl\x12\x1a\n" +
	"\bgroupIds\x18\t \x03(\tR\bgroupIds\"f\n" +
	"\x04Type\x12\x10\n" +
	"\fTYPE_UNKNOWN\x10\x00\x12\x0e\n" +
	"\n" +
	"CIPHERTEXT\x10\x01\x12\x11\n" +
	"\rPREKEY_BUNDLE\x10\x02\x12\v\n" +
	"\aRECEIPT\x10\x03\x12\n" +
	"\n" +
	"\x06TYPING\x10\x04\x12\x10\n" +
	"\fSYNC_MESSAGE\x10\x05B\x1cZ\x1asigma-server/proto;sigmapbb\x06proto3"
