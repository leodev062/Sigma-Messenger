...
class Envelope_Type extends $pb.ProtobufEnum {
  ...
  static const Envelope_Type TYPING =
      Envelope_Type._(4, _omitEnumNames ? '' : 'TYPING');
  static const Envelope_Type SYNC_MESSAGE =
      Envelope_Type._(5, _omitEnumNames ? '' : 'SYNC_MESSAGE');
