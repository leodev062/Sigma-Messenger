...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) return Center(child: Text(context.translate('user_not_found')));
      ...
      child: Column(
        children: [
          ...
          _buildProfileItem(
            ...
            title: user.profileName ?? context.translate('name'),
            onTap: () => _showNameEditBottomSheet(context, user.profileName ?? ''),
          ),
          _buildProfileItem(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                TextButton(onPressed: () => Navigator.pop(context), child: Text(context.translate('btn_cancel'))),
