      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            title: Text(
              context.translate('logout_and_clear_data'),
              style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold),
            ),
            subtitle: Text(context.translate('logout_warning_subtitle')),
            onTap: () => _showLogoutConfirmation(context, authViewModel),
          ),
        ],
      ),
    );
  ...
  void _showLogoutConfirmation(BuildContext context, AuthViewModel authViewModel) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(context.translate('logout_title')),
        content: Text(context.translate('logout_confirmation_message')),
        actions: [
          TextButton(
